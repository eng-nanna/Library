...
<div class="row">
  ...
  <div class="medium-9 column moduleContainer">
       ...
       <?php
		 ...
		 $query="SELECT * FROM books";
		  ...
		  while($rows = mysqli_fetch_array($result)){
			  ?>
        <div class="column">
          <a  href="sell_form.php?id=<?php echo $rows['id'];?>"><img src="../img/books/<?php echo $rows['pic'];?>" class="thumbnail" alt="<?php echo $rows['name'];?>" style="height:200px; width:150px"></a>
        </div>
        <?php
			  }
         ?>
    ...
    echo "<li class='pagination-previous disabled'><a href='sell.php?page=1'>".'First'."</a><span class='show-for-sr'>page</span></li> "; // Goto 1st page  
    
    for ($i=1; $i<=$total_pages; $i++) { 
                echo "<li><a href='sell.php?page=".$i."'>".$i."</a></li> "; 
    }; 
    echo "<li class='pagination-next'><a href='sell.php?page=$total_pages'>".'Last'."</a><span class='show-for-sr'>page</span></a></li> "; // Goto last page
    ?>
    </ul>
