        ...
        <tbody>
         <?php
          ...
          <tr>
            ...
            <td class="text-center editRow"><a href="performance.php?id=<?php echo $row['id'];?>"><i class="fa fa-line-chart"></i></a></td>
