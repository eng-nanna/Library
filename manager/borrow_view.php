 ...
 <input type="submit" class="button" value="Search" name="submit">
      ...
      <table width="100%">
        ...
        <?php
		  ...
		  $query="SELECT * FROM borrows LIMIT $start_from, $num_rec_per_page";
    ...
    echo "<li class='pagination-previous disabled'><a href='borrow_view.php?page=1'>".'First'."</a><span class='show-for-sr'>page</span></li> "; // Goto 1st page  
    
    for ($i=1; $i<=$total_pages; $i++) { 
                echo "<li><a href='borrow_view.php?page=".$i."'>".$i."</a></li> "; 
    }; 
    echo "<li class='pagination-next'><a href='borrow_view.php?page=$total_pages'>".'Last'."</a><span class='show-for-sr'>page</span></a></li> "; // Goto last page
    ?>
    </ul>
